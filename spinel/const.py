...
class SPINEL(object):
    ...
    PROP_NET_PSKC = PROP_NET__BEGIN + 11  # < [D]
    PROP_NET__END = 0x50
    ...
    PROP_THREAD_ACTIVE_DATASET = PROP_THREAD_EXT__BEGIN + 24  # < [A(t(iD))]
    PROP_DATASET_ACTIVE_TIMESTAMP = PROP_THREAD_EXT__BEGIN + 28  # < [X]
    PROP_DATASET_PENDING_TIMESTAMP = PROP_THREAD_EXT__BEGIN + 29  # < [X]
    PROP_DATASET_DELAY_TIMER = PROP_THREAD_EXT__BEGIN + 30  # < [L]
    PROP_DATASET_SECURITY_POLICY = PROP_THREAD_EXT__BEGIN + 31  # < [SC]
